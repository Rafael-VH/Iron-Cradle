...
namespace RobotRepairStation
{
    ...
    public class ThinkNode_ConditionalNeedsRepair : ThinkNode_Conditional
    {
        protected override bool Satisfied(Pawn pawn)
        {
            ...
            // 2. ¿Bajo control del jugador?
            //    Para mecanoides BioTech: Faction == Faction.OfPlayer es siempre true,
            //    así que este check es redundante pero seguro para mods de terceros.
            ...
            // de pawn.jobs (null-safety en estados de transición).
            ...
            // 4. PRE-FILTRO DE SALUD BARATO — evita ejecutar CanReach() para
            //    mecanoides sanos. Usa 0.99f como umbral conservador que cubre
            //    cualquier valor configurable de repairHealthThreshold (máx = 1.0).
            //    La verificación precisa por instancia ocurre en el check 6.
            if (pawn.health.summaryHealth.SummaryHealthPercent >= 0.99f) return false;

            // 5. Búsqueda de estación — operación costosa, solo si pasó todos los filtros.
            var comp = RepairStationUtility.FindBestRepairStationComp(pawn);
            if (comp == null) return false;

            // 6. ¿La salud está bajo el umbral configurado en ESA estación específica?
